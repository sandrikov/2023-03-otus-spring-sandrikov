...
public class GenreCommands {
    ...
    private static final String COMMAND_GROUP_GENRES = "Book Genres";
    ...
    @ShellMethod(value = "Lists genres", key = {"list-genres", "lg"}, group = COMMAND_GROUP_GENRES)
    public String listGenres() {
        ...
        var table = shellHelper.createTable(genres, comparing(Genre::getName),
                a -> new Object[] { a.getName(), a.getId() }, TABLE_HEADER_ROW);
        return table.concat(shellHelper.getSuccessMessage(report));
    }

    @ShellMethod(value = "Get genre by ID", key = {"get-genre", "gg"}, group = COMMAND_GROUP_GENRES)
    ...
    @ShellMethod(value = "Find genre by name", key = {"find-genre", "fg"}, group = COMMAND_GROUP_GENRES)
    ...
    @ShellMethod(value = "Add genre", key = {"add-genre", "ag"}, group = COMMAND_GROUP_GENRES)
    ...
    @ShellMethod(value = "Rename genre", key = {"rename-genre", "rg"}, group = COMMAND_GROUP_GENRES)
    ...
    @ShellMethod(value = "Delete genre", key = {"delete-genre", "dg"}, group = COMMAND_GROUP_GENRES)
    ...
    private String format(Genre genre) {
        return shellHelper.getInfoMessage(String.format("%s id=%d", genre.getName(), genre.getId()));
    }

    private String printSuccess(Genre genre, String report) {
