...
class BookServiceTest {
    ...
    void getBook() {
        ...
        // negative
        assertError(bookService.getBookProjection(99L), getBookNotFoundMessage(99));
    }
    ...
    void createBook() {
        ...
        var book = assertOK(bookService.getBookProjection(newBook.getId()));
    ...
    void createBookDuplicateAlternativeKey() {
        ...
        assertError(bookService.createBook(JEANNE_D_ARC, author.getId(), genre.getId()),
                getBookAlreadyExistsMessage(ALEXANDR_DUMAS, JEANNE_D_ARC));
    }
    ...
    void modifyBookDuplicateAlternativeKey() {
        assertError(bookService.modifyBook(TWAIN_D_ARK_BOOK_ID, ADVENTURES_OF_TOM_SAWYER, null, null),
                getBookAlreadyExistsMessage(MARK_TWAIN, ADVENTURES_OF_TOM_SAWYER));
    }
    ...
    void deleteBook() {
        ...
        assertError(bookService.getBookProjection(TWAIN_D_ARK_BOOK_ID), getBookNotFoundMessage(TWAIN_D_ARK_BOOK_ID));
        // negative
        assertError(bookService.deleteBook(99L), getBookNotFoundMessage(99));
    }
