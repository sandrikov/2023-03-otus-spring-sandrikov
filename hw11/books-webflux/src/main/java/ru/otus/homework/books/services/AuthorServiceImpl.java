...
public class AuthorServiceImpl implements AuthorService {
    ...
    public Reply<AuthorDto> findAuthor(String name) {
        return authorRepository.findByName(name)
                ...
                .orElseGet(() -> error(ServiceErrorMessages.getAuthorNotFoundMessage(name)));
    }
    ...
    public Reply<AuthorDto> createAuthor(String name) {
        if (authorRepository.findByName(name).isPresent()) {
            return error(ServiceErrorMessages.getAuthorAlreadyExistsMessage(name));
        }
    ...
    public Author findAuthor(Long genreId) {
        return ServiceUtils.findById(genreId, authorRepository::findById, ServiceErrorMessages.AUTHOR_NOT_FOUND);
    }
