...
values (default, 'Приключения Тома Сойера', 1, 1, 6),       -- 1
       (default, 'Приключения Гекльберри Финна', 1, 1, 12), -- 2
       (default, 'Том Сойер за границей', 1, 1, 0),         -- 3
       (default, 'Том Сойер, детектив', 1, 3, 12),          -- 4
       (default, 'Жанна д''Арк', 1, 5, 12),                 -- 5
       (default, 'Жанна д''Арк', 4, 4, 12),                 -- 6 одноимённая книга другого автора в другом жанре
       (default, 'Убийство на перепутье', 2, 3, 16),        -- 7
       (default, 'Тайна дымоходов', 2, 3, 16);              -- 8
