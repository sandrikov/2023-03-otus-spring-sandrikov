...
public class BookRepositoryTest {
    ...
    public static final int NUMBER_OF_ADULT_BOOKS = 2;
    ...
    void saveInsert() {
        ...
        val bookToSave = new Book(THREE_MUSKETEERS, author, genre, 16);
        ...
        assertThat(book)
                ...
                .matches(s -> s.getAgeLimit() != null, "Age Limit is presented")
                .isSameAs(saved);
        ...
        assertEquals(16, book.getAgeLimit(), "Age Limit");
